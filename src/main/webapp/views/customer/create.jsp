            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12 d-flex justify-content-center">
                        <div class="card w-50">
                            <div class="card-body">
                                <form action="${pageContext.request.contextPath}/customer/store" method="post" >
                                    <div class="mb-3">
                                        <label for="code" class="form-label">Code Customer</label>
                                        <input type="text" class="form-control" id="code" value="${customer.code}" name="code">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <c:if test="${not empty errors}">
                                            <span id="code-error" class="text-danger">${errors['phone']}</span>
                                        </c:if>
                                    </div>

                                    <div class="mb-3">
                                        <select class="form-select" name="status" aria-label="Default select example">
                                            <option value="1" <c:if test="${customer.status eq 1}">selected</c:if>>Active</option>
                                            <option value="0" <c:if test="${customer.status ne 1}">selected</c:if>>No Active</option>
                                        </select>
...
<script src="../.././js/util/customer/customerValidator.js"></script>
