                    ...
                    <table class="table">
                        ...
                        <c:forEach var="item" items="${listCustomer}" >
                            <tr>
                                ...
                                <td>
                                    <a href="${pageContext.request.contextPath}/customer/edit/${item.id}"> <button class="btn btn-outline-warning">Update</button></a>
                                    <a href="${pageContext.request.contextPath}/customer/delete/${item.id}" onclick="return confirm('Are you sure you want to delete customer ?')"> <button class="btn btn-outline-danger">Delete</button></a>
                                </td>
                            </tr>
                        </c:forEach>
