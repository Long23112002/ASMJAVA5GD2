            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12 d-flex justify-content-center">
                        <div class="card w-50">
                            <div class="card-body">
                                <form action="${pageContext.request.contextPath}/color/store" method="post"  >
                                    <div class="mb-3">
                                        <label for="code" class="form-label">Code Color</label>
                                        <input type="text" class="form-control" id="code" value="${color.code}" name="code">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="name" value="${color.name}" name="name">
                                        <c:if test="${not empty errors}">
                                    ...
                                    <div class="mb-3">
                                        <select class="form-select" name="status" aria-label="Default select example">
                                            ...
                                            <option value="0" <c:if test="${color.status ne 1}">selected</c:if>>No Active</option>
                                        </select>
                                        <span id="status-error" class="text-danger"></span>
                                    </div>


                                    <a href="${pageContext.request.contextPath}/color/index">
